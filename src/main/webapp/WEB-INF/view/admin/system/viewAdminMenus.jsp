...
<body>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <input type="button" class="myButton" value="搜索" onclick="searchMenu();">
                </td>
            </tr>
        </table>
    </div>
    <div class="manage-body">
        <div id="AdminMenu-grid"></div>
    </div>
    ...
    <script src="/resources/scripts/admin/viewAdminMenus.js" type="text/javascript"></script>
</body>
</html>